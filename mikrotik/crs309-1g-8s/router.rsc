...
/interface vlan add interface=bridge1 name=pve-storage vlan-id=107
...
# Add VLANs to ports:
/interface bridge vlan add bridge=bridge1 tagged=bridge1,sfp-sfpplus1,sfp-sfpplus2 untagged=ether1,sfp-sfpplus8 vlan-ids=3,100,105,107,150,200
...
/interface ethernet set [ find default-name=sfp-sfpplus2 ] rx-flow-control=on tx-flow-control=on
